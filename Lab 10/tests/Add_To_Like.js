...
async function Add_To_Like() {
    ...
    await driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/header/div/div[2]/div/div/div[1]/div/div[1]/div/a")).click();
    await driver.findElement(By.xpath("/html/body/div[1]/div/section/div[3]/div/div[1]/div[4]/div[2]/div")).click();
    await driver.sleep(5000);
    await driver.quit();
}
Add_To_Like();